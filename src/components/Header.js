  ...
  return (
    <div className="p-2 m-2 grid grid-flow-col shadow-lg">
      ...
      <div className="col-span-10 px-10">
        ...
        <div className="mt-2 ml-20 p-2 px-5 bg-white rounded-lg w-[37rem] shadow-lg fixed border border-gray-300">
          <ul>
            {suggestions.map((suggestion) => (
              <li key={suggestion} className="shadow-md py-2 hover:bg-gray-100">
                🔍 {suggestion}
              </li>
            ))}
          </ul>
